    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <p class="leading-relaxed">{{ product.blurb }}</p>
          <div
          ...
          >
            <div class="flex">
              ...
              ></button>
              <button
                class="border-2 border-gray-300 ml-1 bg-green-900 rounded-full w-6 h-6 focus:outline-none"
              ></button>
            </div>
            <div class="flex ml-6 items-center">
              ...
              <div class="relative">
                <select
                  class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-green-900 focus:border-green-900 text-base pl-3 pr-10"
                >
                  <option>SM</option>
                  <option>M</option>
                  <option>L</option>
          ...
          <div class="flex">
            ...
            >
            <button
              class="flex ml-auto text-white bg-green-900 border-0 py-2 px-6 focus:outline-none hover:bg-red-900 rounded"
            >
              Buy
            </button>
            <button
